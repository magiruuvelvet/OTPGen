...
FramelessContainer::FramelessContainer(QWidget *target) :
    _target(target),
    ...
    _dragPos(QPoint())
{
    ...
    _rubberband = std::make_shared<QRubberBand>(QRubberBand::Rectangle);
}

bool FramelessContainer::eventFilter(QObject *o, QEvent*e)
{
...
void FramelessContainer::mouseHover(QHoverEvent *e)
{
    updateCursorShape(_target->mapToGlobal(e->pos()));
}

void FramelessContainer::mouseLeave(QEvent*)
{
...
void FramelessContainer::mousePress(QMouseEvent *e)
{
...
void FramelessContainer::mouseRealese(QMouseEvent *e)
{
    if (e->button() & Qt::LeftButton)
    {
        _leftButtonPressed = false;
...
void FramelessContainer::mouseMove(QMouseEvent *e)
{
    if (_leftButtonPressed)
    {
        if (_dragStart)
...
void FramelessContainer::updateCursorShape(const QPoint &pos)
{
...
void FramelessContainer::calculateCursorPosition(const QPoint &pos, const QRect &framerect, Edges &_edge)
{
