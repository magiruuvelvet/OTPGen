...
JSTRING JNI_FUNCTION(Tokens_OTPGen, 00024Companion__1computeTOTP)(JNIEnv *env, jobject,
...
JSTRING JNI_FUNCTION(Tokens_OTPGen, 00024Companion__1computeTOTP_1AtTime)(JNIEnv *env, jobject,
...
JSTRING JNI_FUNCTION(Tokens_OTPGen, 00024Companion__1computeHOTP)(JNIEnv *env, jobject,
...
JSTRING JNI_FUNCTION(Tokens_OTPGen, 00024Companion__1computeSteam)(JNIEnv *env, jobject,
    jstring secret)
{
    auto err = OTPGenErrorCode::Valid;
...
JSTRING JNI_FUNCTION(Tokens_OTPGen, 00024Companion__1computeSteam_1AtTime)(JNIEnv *env, jobject,
